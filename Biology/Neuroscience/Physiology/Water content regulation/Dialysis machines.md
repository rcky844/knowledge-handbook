**Dialysis machines** are used in patients with <u>kidney failures</u> to perform <span style="color: violet">haemodialysis</span>, which can <span class="hi-green">remove wastes and excess salts</span> from the blood.
