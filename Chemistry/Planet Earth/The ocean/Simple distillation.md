**Simple distillation** is a <span class="hi-blue">physical process</span> which boils and evaporates the solvent, then condenses its vapour so that the pure solvent can be obtained.
